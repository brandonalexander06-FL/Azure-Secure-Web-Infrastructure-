...
**Network Hardening**
* Replaced default "Allow All" firewall rules with granular Network Security Groups (NSG).
* Implemented "Least Privilege Access" to deny all non-essential traffic.

**Traffic Segmentation**
* Restricted SSH on Port 22 to a single trusted IP address (Whitelisting).
* Configured a Virtual Network (VNet) to isolate management traffic from public network traffic.

**Live Monitoring**
* Utilized 'access.log' monitoring to track request patterns in real time.
* Validated traffic sources to distinguish between legitimate user traffic and bot scanning activity.
...
* **Web Server:** Nginx
* **Networking:** Azure VNet, Network Security Groups (NSG), Public IP
...
![Network Topology Diagram](SS2%20Topology.png)
...
![Firewall Rules](SS1%20Firewall.png)
...
![Live Web Page](SS3%20Webpage.png)
